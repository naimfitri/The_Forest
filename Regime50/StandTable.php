        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($categories as $category) {
                    ...
                    $query = "SELECT * FROM new_forest_50 WHERE spgroup = " . $category['spgroup'];
                ...
                foreach ($categories as $category) {
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            if ($diameter >= 5 && $diameter <= 15) {
                                if ($row['production3050'] == 1) {
                                    $totalVolume1[] = $row['Volume'];
                                }
                                $totalNumber1[] = $row['production3050'];
                            } elseif ($diameter > 15 && $diameter <= 30) {
                                if ($row['production3050'] == 1) {
                                    $totalVolume2[] = $row['Volume'];
                                }
                                $totalNumber2[] = $row['production3050'];
                            } elseif ($diameter > 30 && $diameter <= 45) {
                                if ($row['production3050'] == 1) {
                                    $totalVolume3[] = $row['Volume'];
                                }
                                $totalNumber3[] = $row['production3050'];
                            } elseif ($diameter > 45 && $diameter <= 60) {
                                if ($row['production3050'] == 1) {
                                    $totalVolume4[] = $row['Volume'];
                                }
                                $totalNumber4[] = $row['production3050'];
                            } elseif ($diameter > 60) {
                                if ($row['production3050'] == 1) {
                                    $totalVolume5[] = $row['Volume'];
                                }
                                $totalNumber5[] = $row['production3050'];
                            }
                        }
                    }
