...
if ($spgroup == 8) {
    $count_query = "SELECT * FROM new_forest_50 WHERE BlockX = $blockX AND BlockY = $blockY";
} else {
    $count_query = "SELECT * FROM new_forest_50 WHERE BlockX = $blockX AND BlockY = $blockY AND spgroup = $spgroup";
